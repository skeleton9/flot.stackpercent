...
(function ($) {
    ...
    FlotTooltip.prototype.stringFormat = function(content, item) {
        ...
        if (typeof item.series.threshold !== "undefined" || typeof (item.series.percents) !== 'undefined') {
            x = item.datapoint[0];
            y = item.datapoint[1];
        } else {
    ...
    //set percentage for stacked chart
		FlotTooltip.prototype.processRawData = function(plot, series, data, datapoints) 
		{	
			if (!processed)
			{
				processed = true;
    ...
    //calculate summary
    FlotTooltip.prototype.getStackSums = function(_data) {
